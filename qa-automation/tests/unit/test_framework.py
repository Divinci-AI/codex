...
class TestFramework:
    ...
    def test_mock_support(self):
        ...
        # Test patch with a safer approach
        def mock_function():
            return "original"

        with patch.object(self, '_test_function', return_value="patched") as mock_func:
            # Test that we can patch and call
            result = mock_func()
        ...
        magic_mock.some_method.return_value = "magic"
        assert magic_mock.some_method() == "magic"

    def _test_function(self):
        """Helper function for mock testing."""
        return "original"
